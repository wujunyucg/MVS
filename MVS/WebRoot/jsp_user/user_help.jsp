...
<body>
	...
	<div style="margin:60px 180px;">
		...
		<div class="panel panel-default per-info-div" id="7">
			...
			<div class="panel-footer">
				车厂图标为<img alt="" src="<%=path%>/icons/car_factory.svg"><br/>
				...
				自动生成线路后，线路上所有站点变为绿色图标<img alt="" src="<%=path%>/icons/znzd.svg">且不可编辑 <br /> <br /> <strong>2.
				...
				手动创建路线同样分为对未排站点进行规划和对所有站点进行规划，如果选择对未排站点进行规划，地图上将显示所有未排站点（蓝色图标<img alt="" src="<%=path%>/icons/stations.svg">），如果选择对所有站点进行规划，将自动清空所有历史线路，并在地图上显示所有站点（蓝色图标）。右键点击地图上的蓝色站点图标（蓝色即为未排站点），共有四个选项，设为起点、路径径点、取消设置和查看路线，管理员可手动依次点击所需站点生成线路，选中的站点图标将变为红色<img alt="" src="<%=path%>/icons/stationOnRoute.svg">，
				点击查看路线，当前路线的所有站点显示为黄色<img alt="" src="<%=path%>/icons/newrtsizt.svg">
				正在编辑的被删除的站点为紫色<img alt="" src="<%=path%>/icons/newLS.svg">
				<br />
				<br />
			</div>
		</div>
