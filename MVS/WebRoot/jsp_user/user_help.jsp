	...
	<div style="float: left">
		<div class="panel panel-default">
			...
			<div class="list-group">
				<a class="list-group-item disabled" href="javascript:;">员工管理</a> <a
					class="guide list-group-item" id="1a" href="javascript:;">数据维护</a>
				<a class="guide list-group-item" id="2a" href="javascript:;">数据同步</a>
				<a class="list-group-item disabled" href="javascript:;">车辆管理</a> <a
					class="guide list-group-item" id="3a" href="javascript:;">新建车辆数据</a>
				<a class="guide list-group-item" id="4a" href="javascript:;">数据维护与查询</a>
				<a class="list-group-item disabled" href="javascript:;">站点管理</a> <a
					class="guide list-group-item" id="5a" href="javascript:;">站点维护</a>
				<a class="guide list-group-item" id="6a" href="javascript:;">数据统计</a>
				<a class="list-group-item disabled" href="javascript:;">线路管理</a> <a
					class="guide list-group-item" id="7a" href="javascript:;">线路维护</a>
				<a class="guide list-group-item" id="8a" href="javascript:;">统计分析</a>
				<a class="list-group-item disabled" href="javascript:;">班次管理</a> <a
					class="guide list-group-item" id="9a" href="javascript:;">新增班次</a>
				<a class="guide list-group-item" id="aa" href="javascript:;">数据维护</a>
			</div>
		</div>
	</div>
	<div style="margin-left:180px;">
		...
		<div class="panel panel-default per-info-div" id="7">
			...
			<div class="panel-footer">
				...
				自动生成线路后，线路上所有站点变为绿色图标且不可编辑 <br />
				<br /> <strong>2. 显示全部路线 </strong><br>
				点击该按钮，可以在地图上看到所有线路的分布情况。 <br /> <br /> <strong>3.显示/隐藏站点</strong><br>
		...
		<div class="panel panel-default per-info-div" id="8">
			...
			<div class="panel-footer"
			>管理员可选择查询周期——天、周、月，在选中相应时间后，下方会以柱状图形式直观显示各线路乘坐率情况，点击统计图右上方，可以excel形式导出统计数据。
根据已有信息，统计图下方会显示建议优化的线路名称，点击“线路优化建议”，可查看详细的数据分析情况和线路优化建议。其中以天统计页面，下方还设置有“线路人员”查询按钮，可以提供对某一线路乘车人员名单的查询和导出服务
		...
		<div class="panel panel-default per-info-div" id="a">
			...
			<div class="panel-footer">
				可以点击“按月查看”，查看某月份排班数据，
				也可点击“全部班次”查看全部班次的详细信息，选中班次可进行修改或删除操作。<br/>
