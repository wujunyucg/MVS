...
<html>
  ...
  <div class="tab-content">
    ...
    <input type="text" class="form-control" name = "satff_number" placeholder="员工工号" style="width: 300px">
  	</div>
  </div>
  ...
  function immed_manual(){
  	...
  	$("#w-modal-but").html("同步");
  	var content='<div class="form-group form-inline"><label for="exampleInputName2" style="font-size: 15px">员工工号：</label><input type="text" class="form-control" id="staff_number"  name = "staff_number" placeholder="员工工号" style="width: 300px"></div>'
  ...
  $("input").blur(function(){
  		...
  		if($(this).attr("id")=="staff_number"){
  			$.ajax({ 
				type:"post",
				url: "<%=basePath%>servlet/SynchUserServlet", 
				data:{
								type : "0",
								number :$(this).val() ,			
					},
